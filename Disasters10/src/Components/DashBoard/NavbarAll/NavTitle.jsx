...
function NavTitle({P,H}) {
  return (
    <div>
        <DashContainer className='font-onest grid justify-center place-items-center md:flex md:justify-between items-center px-5 '>
